...
core.register_craftitem("amber:amber", {
	description = "Amber",
	inventory_image = "amber.png",
})

core.register_craftitem("amber:amber_lump", {
	description = "Amber Lump",
	inventory_image = "amber_lump.png",
})

core.register_craftitem("amber:brick", {
	description = "Amber Brick",
	inventory_image = "amber_brick.png",
})

core.register_craftitem("amber:glass_tile", {
	description = "Amber Glass Tile",
	inventory_image = "amber_glass_tile.png",
})

core.register_craftitem("amber:green_crystals", {
